...
const suppliers: SeedSupplier[] = [
  ...
  },
  {
    ...
    region_code: "US-CA",
    geo: { kind: "point", lat: 33.7701, lon: -118.1937 },
  ...
  },
  {
    ...
    region_code: "CN",
    geo: { kind: "point", lat: 22.5431, lon: 114.0579 },
  ...
  },
  {
    ...
    region_code: "DE",
    geo: { kind: "point", lat: 50.1109, lon: 8.6821 },
  ...
  },
  {
    ...
    region_code: "MX",
    geo: { kind: "point", lat: 25.6866, lon: -100.3161 },
  ...
  },
  {
    ...
    region_code: "JP",
    geo: { kind: "point", lat: 35.6762, lon: 139.6503 },
...
const shipments: ShipmentInsert[] = skus.map((sku, index) => ({
  ...
  dest_geo: { kind: "point", lat: 41.8781, lon: -87.6298 },
  route_regions: [
