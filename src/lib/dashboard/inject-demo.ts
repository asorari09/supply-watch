        ...
        const { error: draftError } = await client.from("comms_drafts").upsert(
          {
            ...
            generation: 1,
            subject: `Simulated scenario: ${pending.flag.signal.disruptionType.replaceAll("_", " ")}`,
            body: `Simulated scenario disruption: a ${pending.flag.signal.disruptionType.replaceAll("_", " ")} affects this supply route. Please confirm the updated delivery plan and available mitigation options.`,
